...
table.addEventListener("click", (e)=>{
    ...
    if (target.innerText === "Age") {
        const sortAge = ceils.sort((rowA, rowB)=>rowA.cells[2].innerHTML - rowB.cells[2].innerHTML);
        table.tBodies[0].append(...sortAge);
    }
    if (target.innerText === "Salary") {
        const sortSalary = ceils.sort((a, b)=>getNumber(a.cells[3].innerHTML) - getNumber(b.cells[3].innerHTML));
